...
activities = {
    ...
    "Soccer Team": {
        "description": "Develop teamwork and fitness through competitive soccer matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 24,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming techniques and endurance in guided practice sessions",
        "schedule": "Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "School Band": {
        "description": "Practice instruments and perform at school events and competitions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Build acting and stage skills through rehearsals and live performances",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Check if student is signed up before removing
